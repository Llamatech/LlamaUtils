...
public class CopyOfLlamaTrie<T> 
{	
	public CopyOfTrieNode<T> root;

	public CopyOfLlamaTrie()
	{
		root = new CopyOfTrieNode<T>();
	}
	...
	{
		CopyOfLlamaTrie<String> trie = new CopyOfLlamaTrie<String>();

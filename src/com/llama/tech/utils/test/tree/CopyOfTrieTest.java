...
public class CopyOfTrieTest extends TestCase{

	private CopyOfLlamaTrie<String> trie;
	private Lista<String> lista;

	public void setupEscenario1()
	{
		trie = new CopyOfLlamaTrie<String>();
	...
	public void testAgregar()
	{
		...
		CopyOfTrieNode<String> init =  trie.root.getChild();
